...
| `versions/Phase2_v1_policy.py` | Original A1 baseline — historical reference |
| `versions/EXP-20260815-69_policy.py` | **Current champion baseline** — use for comparisons |
